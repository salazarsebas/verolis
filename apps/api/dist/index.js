...
app.use(paymentMiddleware(paymentRequirements, new x402ResourceServer(facilitatorClient).register("stellar:testnet", new ExactStellarScheme())));
app.use(cors());
...
app.get("/api/supported", (req, res) => {
    res.json({
        ...
        endpoints: Object.keys(paymentRequirements).map((key) => {
            ...
            const req = paymentRequirements[key];
            return {
                method,
                path,
